...
namespace HttpPing.Tests
{
    ...
    public class ProgramTests
    {
        ...
        {
            var expectedValue = "Sending HTTP requests to [http://www.starwars.com]:\r\nResponse from www.starwars.com: Code=200:OK Size=-1\r\nResponse from www.starwars.com: Code=200:OK Size=-1\r\n";

            string[] parameters = new string[] { "www.starwars.com", 
                                                "-n", "1",
                                                "-i", "250" };
        ...
        public void When_params_webaddress_contains_dash_should_not_return_error_test()
        {
            ...
            string[] parameters = new string[] { "demo-api.starwars.com" };
